...
@AutoValue
public abstract class ScaleTargetRef {

  public abstract String name();

  static ScaleTargetRef fromYamlMap(Map<String, Object> input, String resourcePath) {
  ...
  public abstract static class Builder {
    ...
    public abstract ScaleTargetRef build();
  }

  public static Builder builder() {
    return new AutoValue_ScaleTargetRef.Builder();
  }
}
